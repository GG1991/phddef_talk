...
For each boundary condition type and algorithm test :
 \begin{itemize}
  \item different solvers and matrix storage formats.
  \item different architectures and parallelization strategies.
 \end{itemize}

 \item \textcolor{Red}{Long term goal}: Solve a large problem with \texttt{Alya} :
 \begin{itemize}
  \item couple the microscopic code with \texttt{Alya}.
...
\ganttbar{\textit{micro} development}{6}{36} \\
\ganttbar{\textit{macro} development}{6}{36} \\

\ganttgroup{\textit{Alya}}{14}{36} \\
\ganttbar{Integrate \textit{micro}}{14}{36} \\
